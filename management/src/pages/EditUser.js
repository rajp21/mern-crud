...
export const EditUser = () => {
    ...
    useEffect(() => {
        async function loadUser(){
            try{
                const user = await Axios.get('/single-user'); 
                console.log(user.data); 
                const {firstName, lastName, company, email, phone} = user.data; 
    ...
    const editUser  = async (e) => {
        ...
        try{
            const post = await Axios.post('/edit-user', {id, firstName, lastName, company, email, phone}); 
    ...
    <div className='adduser'>
        ...
        <div className='adduser-form'>
            ...
            <div className='text-center'>
                <button onClick={editUser} type="submit" className="btn btn-dark btn-block mb-4">Edit User</button>
            </div>
          </form>
